...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, head_dim=None, window_size=None, num_heads=8, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.,conv=False,conv_k=3,conv_2d=True,conv_bias=False,conv_type='attn',**kawrgs):
...
class SwinAttntion1D(nn.Module):
    def __init__(self, dim, input_resolution=None, head_dim=None,num_heads=8, window_size=None, shift_size=0,qkv_bias=True, qk_scale=None, drop=0., attn_drop=0., window_num=8,**kawrgs):
        super().__init__()
