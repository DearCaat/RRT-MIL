...
def one_fold(args,k,ckc_metric,train_p, train_l, test_p, test_l,val_p,val_l):
    ...
    if args.model == 'rttmil':
        model_params = {
            ...
            'conv_k': args.epeg_k,
            'conv_2d': args.epeg_2d,
            'conv_bias': args.epeg_bias,
            'conv_type': args.epeg_type,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epeg', action='store_false', help='lr_scheduler_update_per_iter')
    parser.add_argument('--epeg_bias', action='store_false', help='lr_scheduler_update_per_iter')
    parser.add_argument('--epeg_2d', action='store_true', help='lr_scheduler_update_per_iter')
    parser.add_argument('--epeg_k', default=15, type=int, help='position of pos embed [-1,0]')
    parser.add_argument('--epeg_type', default='attn', type=str, help='Camelyon16')
